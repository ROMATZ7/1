...
function checkMatch() {
    if (firstCard.dataset.value === secondCard.dataset.value) {
        ...
        setTimeout(() => {
            // Intercambiar los símbolos entre las dos cartas
            const tempValue = firstCard.dataset.value;
            firstCard.dataset.value = secondCard.dataset.value;
            secondCard.dataset.value = tempValue;

            // Actualizar el contenido visible de las cartas
            firstCard.textContent = firstCard.dataset.value;
            secondCard.textContent = secondCard.dataset.value;

            // Ocultar las cartas (volver a girarlas)
